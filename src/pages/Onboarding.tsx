...
const Onboarding = () => {
  ...
  const stepTitles = ['Personal Info', 'Professional Info', 'Preferences', 'Welcome']
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      ...
      case 4:
        return <WelcomeStep onComplete={handleComplete} userRole={user?.role || 'slp'} />
      default:
        return null
    }
  }
  ...
  return (
    <div className='min-h-screen bg-gray-50 py-8 px-4'>
      <div className='max-w-3xl mx-auto'>
        ...
        <OnboardingProgress currentStep={currentStep} totalSteps={4} stepTitles={stepTitles} />
