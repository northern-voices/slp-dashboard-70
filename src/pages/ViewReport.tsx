...
const generateProgramCaseloadPdf = async (reportData: unknown) => {
  const [{ pdf }, { default: ProgramCaseloadPdf }] = await Promise.all([
    import('@react-pdf/renderer'),
    import('@/components/reports/pdf/ProgramCaseloadPdf'),
  ])
