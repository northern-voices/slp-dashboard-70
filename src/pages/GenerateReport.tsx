          ...
          <main className="flex-1 p-4 md:p-6 lg:p-8 pb-8 overflow-x-hidden max-w-full">
            <div className="space-y-6">
              ...
              <div className="space-y-1 sm:space-y-2">
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-900">Generate Report</h1>
                <p className="text-sm sm:text-base text-gray-600">Create comprehensive class-wide reports for students</p>
              </div>
