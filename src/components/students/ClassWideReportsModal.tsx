          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className='w-full'>
            <div className='overflow-x-auto'>
              <TabsList className='w-full justify-start flex-nowrap h-auto p-1 min-w-max'>
                <TabsTrigger value='hearing' className='flex-shrink-0 whitespace-nowrap'>
                  Hearing
                </TabsTrigger>
                <TabsTrigger value='speech-screens' className='flex-shrink-0 whitespace-nowrap'>
                  Speech Screens
                </TabsTrigger>
                <TabsTrigger value='goal-sheets' className='flex-shrink-0 whitespace-nowrap'>
                  Goal Sheets
                </TabsTrigger>
                <TabsTrigger value='progress' className='flex-shrink-0 whitespace-nowrap'>
                  Progress
                </TabsTrigger>
              </TabsList>
            </div>
