        ...
        <CardContent className="p-6">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Badge variant={student.active ? "default" : "secondary"} className="bg-emerald-100 text-emerald-800 hover:bg-emerald-200">
                      {student.active ? 'Active' : 'Inactive'}
                    </Badge>
                    <Badge variant="outline" className="border-blue-200 text-blue-700 bg-blue-50">Grade {student.grade}</Badge>
                  </div>
                </div>
              </div>
              ...
              {/* Notes */}
              {student.notes && (
                <div className="mt-4 p-3 bg-gradient-to-r from-blue-50 to-blue-25 border border-blue-200 rounded-lg">
