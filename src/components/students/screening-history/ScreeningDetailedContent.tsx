...
const ScreeningDetailedContent = ({ screening }: ScreeningDetailedContentProps) => {
          ...
          <div className='space-y-4'>
            <div>
              ...
              <p className='text-sm text-gray-600'>
                {screening.results ||
                  'Comprehensive speech sound assessment completed. All phonemes assessed in initial, medial, and final positions.'}
              </p>
            </div>
            <div>
              <h4 className='font-medium text-gray-900 mb-2'>Language Assessment</h4>
              <p className='text-sm text-gray-600'>
                Receptive and expressive language skills evaluated. Age-appropriate vocabulary and
                sentence structure observed.
              </p>
            </div>
            <div>
              <h4 className='font-medium text-gray-900 mb-2'>Recommendations</h4>
              <p className='text-sm text-gray-600'>
                Continue monitoring speech development. No immediate intervention required at this
                time.
              </p>
            </div>
          </div>
        ...
        return (
          <div className='space-y-4'>
            <div>
              ...
              <p className='text-sm text-gray-600'>
                {screening.results ||
                  'Hearing thresholds within normal limits bilaterally across all frequencies tested.'}
              </p>
            </div>
            <div>
        ...
        return (
          <div className='space-y-4'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-600'>
                {screening.results ||
                  'Improved articulation accuracy in structured activities. Generalization to conversational speech in progress.'}
              </p>
            </div>
            <div>
              <h4 className='font-medium text-gray-900 mb-2'>Next Steps</h4>
              <p className='text-sm text-gray-600'>
                Continue current intervention strategies. Increase focus on generalization
                activities.
              </p>
            </div>
          </div>
  ...
  return (
    <Card>
      ...
      <CardContent>{getDetailedContent()}</CardContent>
    </Card>
  )
}
