...
const ScreeningCard = ({ screening, onViewDetails }: ScreeningCardProps) => {
  ...
  const getResultBadge = (result?: string) => {
    ...
    const resultConfig = {
      absent: { label: 'Absent', color: 'bg-gray-100 text-gray-800 border-gray-200' },
      age_appropriate: {
      ...
      mild: { label: 'Mild', color: 'bg-yellow-100 text-yellow-800 border-yellow-200' },
      mild_moderate: {
        label: 'Mild Moderate',
      ...
      severe: { label: 'Severe', color: 'bg-red-100 text-red-800 border-red-200' },
      severe_profound: {
