...
const SLPSchoolBrowser = () => {
  const { availableSchools, setCurrentSchool, isLoading } = useOrganization()
      ...
      <Card>
        <CardContent className='p-6 text-center'>
          ...
          <p className='text-gray-600 text-sm'>
            You don't have any schools assigned yet. Contact your administrator.
          </p>
        </CardContent>
      </Card>
    )
    ...
    <div className='space-y-6'>
      <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
        <div>
          ...
          <p className='text-gray-600 text-sm'>
            Schools where you can manage students and conduct screenings
          </p>
        </div>
        <Badge variant='secondary' className='bg-blue-100 text-blue-800'>
          {availableSchools.length} Schools Assigned
        </Badge>
      </div>
