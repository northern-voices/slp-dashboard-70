                ...
                <Card key={template.id} className='hover:shadow-md transition-shadow'>
                  ...
                  <CardContent>
                    <div className='space-y-2 mb-4'>
                      ...
                      <p className='text-sm'>
                        <strong>Last Modified:</strong> {template.lastModified}
                      </p>
                      <p className='text-sm'>
                        <strong>Usage:</strong> {template.usage} times
                      </p>
                    </div>
          ...
          <TabsContent value='settings' className='space-y-4'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure global template preferences</CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-4'>
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Configure default settings for new templates
                    </p>
                  </div>
