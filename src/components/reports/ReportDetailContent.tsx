...
import { Download, FileText, Volume2, Mic, Target, TrendingUp, Calendar, Users, GraduationCap } from 'lucide-react';
...
const ReportDetailContent = ({ reportId }: ReportDetailContentProps) => {
  ...
  const report = {
    ...
    grades: ["K", "1st", "2nd"],
    studentCount: 68,
    description: "Comprehensive hearing screening assessment conducted across multiple grade levels to identify students who may require additional audiological evaluation or intervention services.",
    summary: "This report presents the results of hearing screenings conducted for 68 students across Kindergarten, 1st, and 2nd grades during the Fall 2024 semester. The screening process followed standard protocols to assess hearing acuity and identify students who may benefit from further evaluation.",
    results: {
      passed: 62,
      failed: 4,
      incomplete: 2
