...
const GenericSpeechScreeningReportView = ({ data }: { data: StudentSpeechReportData }) => {
  ...
  return (
    <div className="space-y-6 print:space-y-0 font-['Nunito']">
      ...
      {errorChunks.map((chunk, i) => {
        ...
        const isLastErrorPage = i === errorChunks.length - 1
        ...
        return (
          <section
            ...
            <div className='flex-1'>
              ...
              {isLastErrorPage && copy?.footerNote && (
                <p className="font-['Montserrat'] text-sm italic text-gray-600">
                  {copy.footerNote}
                </p>
              )}
            </div>
...
export default GenericSpeechScreeningReportView
