...
const AbsentHearingReportView = ({ data }: { data: HearingReportData }) => {
  const { context } = data
      ...
      <section className='bg-white shadow-sm w-full aspect-[8.5/11] pt-6 px-10 pb-8 flex flex-col print:shadow-none print:pt-6 print:px-10 print:pb-8'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-gray-700 leading-snug mb-2.5'>
            ...
            screen your child due to their <span className='font-bold'>absence</span> on the
            screening day.
          </p>

          <p className='text-gray-700 leading-snug mb-2.5'>
            Since hearing plays a big role in speech, language, and learning, we recommend regular
            hearing evaluations. Even a mild or temporary hearing loss—such as from ear infections
            or wax buildup—can impact a child's ability to communicate and excel in school.
          </p>
...
export default AbsentHearingReportView
