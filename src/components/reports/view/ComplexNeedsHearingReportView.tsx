...
const ComplexNeedsHearingReportView = ({ data }: { data: HearingReportData }) => {
  const { context } = data
      ...
      <section className='bg-white shadow-sm w-full aspect-[8.5/11] pt-6 px-10 pb-8 flex flex-col print:shadow-none print:pt-6 print:px-10 print:pb-8'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-gray-700 leading-snug mb-2.5'>
            We recently conducted hearing screenings at the school; however, we were{' '}
            <span className='font-bold'>unable to complete the screening</span> using our standard
            procedures and recommend a more individualized evaluation for your child, if needed.
          </p>
...
export default ComplexNeedsHearingReportView
