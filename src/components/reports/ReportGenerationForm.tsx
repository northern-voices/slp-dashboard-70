  ...
  const onSubmit = async (data: ReportFormData) => {
    try {
      ...
      toast({
        ...
        description: `Your ${reportTypes.find(type => type.value === data.reportType)?.label} is being generated. You'll receive an email at ${data.email} when it's ready.`,
      });
                  ...
                  <FormItem className="space-y-3">
                    ...
                    <FormControl>
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          <h3 className="text-sm font-medium text-gray-900">Tracking & Progress Reports</h3>
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
