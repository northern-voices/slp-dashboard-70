...
const NonCompliantHearingReportPdf = ({ data }: { data: HearingReportData }) => {
  const { context } = data
    ...
    <Document>
      <Page size='LETTER' style={styles.page}>
        ...
        <Text style={styles.paragraph}>
          ...
          <Text style={styles.bold}>not comfortable participating</Text>.
        </Text>
...
export default NonCompliantHearingReportPdf
