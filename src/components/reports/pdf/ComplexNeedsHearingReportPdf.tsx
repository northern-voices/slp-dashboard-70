...
const ComplexNeedsHearingReportPdf = ({ data }: { data: HearingReportData }) => {
  const { context } = data
    ...
    <Document>
      <Page size='LETTER' style={styles.page}>
        ...
        <Text style={styles.paragraph}>
          ...
          <Text style={styles.bold}>unable to complete the screening</Text> using our standard
...
export default ComplexNeedsHearingReportPdf
