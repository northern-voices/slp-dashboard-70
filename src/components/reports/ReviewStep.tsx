...
import { CheckCircle, FileText, Calendar, Filter, Mail, Clock, AlertCircle } from 'lucide-react'
        ...
        <CardContent className='space-y-3'>
          ...
          {formData.customMessage && (
            <div>
              ...
              <div className='text-sm bg-gray-50 p-2 rounded mt-1'>{formData.customMessage}</div>
            </div>
          )}
        </CardContent>
      </Card>
            ...
            <div className='flex items-start space-x-3'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700 mt-1'>
                  Your scheduled report is configured correctly and ready to be activated. The first
                  report will be generated on {formData.startDate} at {formData.timeOfDay}.
                </p>
              </div>
            </div>
          </CardContent>
