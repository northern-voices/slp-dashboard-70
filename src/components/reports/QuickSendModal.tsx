...
import { Mail, Link, MessageSquare, Calendar, Users, Send, Clock, Share2 } from 'lucide-react'
...
const QuickSendModal = ({ isOpen, onClose, reportTitle, reportId }: QuickSendModalProps) => {
  const [selectedMethod, setSelectedMethod] = useState<'email' | 'link' | 'sms' | 'schedule'>(
    'email'
  )
