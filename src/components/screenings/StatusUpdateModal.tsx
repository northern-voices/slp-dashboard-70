...
const StatusUpdateModal = ({ isOpen, onClose, selectedScreenings, onUpdate }: StatusUpdateModalProps) => {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the status for {selectedScreenings.length} selected screening{selectedScreenings.length > 1 ? 's' : ''}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            <p className="text-sm text-gray-600">
              This will update the status for <strong>{selectedScreenings.length}</strong> screening{selectedScreenings.length > 1 ? 's' : ''}.
              {reason && (
                <>
                  <br />
