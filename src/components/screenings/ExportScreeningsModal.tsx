...
const ExportScreeningsModal = ({
  isOpen,
  onClose,
  selectedScreenings,
  onExport,
}: ExportScreeningsModalProps) => {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className='sm:max-w-md'>
        <DialogHeader>
          ...
          <DialogDescription>
            Export {selectedScreenings.length} selected screening
            {selectedScreenings.length > 1 ? 's' : ''} to a file
          </DialogDescription>
        </DialogHeader>
            ...
            <div className='space-y-3'>
              <div className='flex items-center space-x-2'>
                ...
                <label htmlFor='details' className='text-sm'>
                  Student details and screening info
                </label>
              </div>
              <div className='flex items-center space-x-2'>
                <Checkbox
