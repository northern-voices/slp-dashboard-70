      ...
      <DialogContent className="max-w-4xl">
        ...
        <div className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => handleCreateScreening('speech')}>
            ...
            <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => handleCreateScreening('hearing')}>
              <CardHeader className="text-center">
