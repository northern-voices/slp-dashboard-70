...
} from '@/types/student-enhancements'
      ...
      <CardContent className='space-y-3'>
        <div className='flex items-center gap-4 text-sm text-gray-600'>
          <div className='flex items-center gap-1'>
            ...
            {format(new Date(ticket.start_date), 'MMM d')} -{' '}
            {format(new Date(ticket.end_date), 'MMM d, yyyy')}
          </div>
          <div className='flex items-center gap-1'>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-sm text-gray-700 line-clamp-2'>{ticket.notes}</p>
