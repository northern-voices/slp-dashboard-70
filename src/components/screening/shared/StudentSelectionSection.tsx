        ...
        <Card className='p-4 bg-blue-50'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div>
              ...
              <Input {...form.register('first_name')} placeholder='Enter first name' />
            </div>
            <div>
              <Label htmlFor='last_name'>Last Name *</Label>
              <Input {...form.register('last_name')} placeholder='Enter last name' />
            </div>
            <div>
            ...
            <div>
              ...
              <Input {...form.register('grade')} placeholder='e.g., K, 1, 2' />
            </div>
          </div>
        </Card>
      ) : (
