        ...
        <CardContent className='space-y-4'>
          <div>
            ...
            <p className='text-sm text-gray-600 mb-3'>
              Select the sounds that show consistent error patterns
            </p>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        <Card>
          ...
          <CardContent>
            <div className='space-y-3'>
              ...
              <Textarea placeholder='Additional voice quality observations...' rows={2} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='space-y-3'>
              <div className='flex flex-wrap gap-2'>
                {['Typical', 'Repetitions', 'Prolongations', 'Blocks', 'Secondary behaviors'].map(
                  pattern => (
                    <Badge
                      key={pattern}
                      variant='outline'
              ...
              <Textarea placeholder='Describe fluency patterns, frequency, severity...' rows={2} />
            </div>
          </CardContent>
        </Card>
      </div>
