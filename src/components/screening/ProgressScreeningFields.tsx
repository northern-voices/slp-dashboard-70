        ...
        <CardContent className='space-y-6'>
          <div>
            ...
            <p className='text-sm text-gray-600 mb-3'>
              List goals that have been achieved or mastered
            </p>
          ...
          <div>
            ...
            <p className='text-sm text-gray-600 mb-3'>
              List goals currently being worked on with progress notes
            </p>
            <div className='space-y-2'>
        ...
        <CardContent className='space-y-4'>
          <div>
            ...
            <div className='flex gap-2 mt-2'>
              {['Exceeding', 'Meeting', 'Progressing', 'Limited Progress', 'Regression'].map(
                rating => (
                  <Badge
                    key={rating}
                    variant='outline'
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          <div>
            ...
            <Textarea placeholder='Note any new areas of concern that have emerged...' rows={3} />
          </div>
