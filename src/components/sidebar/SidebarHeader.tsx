...
const SidebarHeader = () => {
  ...
  return <SidebarHeaderComponent className="border-b border-gray-50 px-6 py-5 bg-white">
      ...
      <div className="flex items-center space-x-3 mb-6">
        <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-sm overflow-hidden">
          <img src="/lovable-uploads/60550859-aeae-4648-81dc-f233a9d39217.png" alt="Organization Logo" className="w-full h-full object-contain" />
        </div>
