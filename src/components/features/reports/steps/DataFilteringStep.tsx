    ...
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600 mb-6'>
          Select which data to include in your scheduled reports. Leave selections empty to include
          all available data.
        </p>
      </div>
        ...
        <CardHeader>
          <CardTitle className='text-base flex items-center justify-between'>
            ...
            <div className='flex space-x-2'>
              <Button variant='outline' size='sm' onClick={() => selectAll(mockSchools, 'schools')}>
                Select All
              </Button>
              <Button variant='outline' size='sm' onClick={() => clearAll('schools')}>
                Clear All
              </Button>
            </div>
          </CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle className='text-base flex items-center justify-between'>
            ...
            <div className='flex space-x-2'>
              <Button variant='outline' size='sm' onClick={() => selectAll(gradeOptions, 'grades')}>
                Select All
              </Button>
              <Button variant='outline' size='sm' onClick={() => clearAll('grades')}>
                Clear All
              </Button>
            </div>
          </CardTitle>
        ...
        <CardHeader>
          <CardTitle className='text-base flex items-center justify-between'>
            ...
            <div className='flex space-x-2'>
              ...
              <Button variant='outline' size='sm' onClick={() => clearAll('screeningTypes')}>
                Clear All
              </Button>
            </div>
          </CardTitle>
              ...
              {screeningTypeOptions.map(type => (
                <label
                  ...
                  <input
                    ...
                    onChange={() =>
                      toggleSelection(formData.screeningTypes, type, 'screeningTypes')
                    }
                    className='rounded'
                  />
