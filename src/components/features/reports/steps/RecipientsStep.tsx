...
const RecipientsStep = ({ formData, updateFormData }: RecipientsStepProps) => {
  ...
  const addPresetRecipients = (role: string) => {
    ...
    const newRecipients =
      presetEmails[role as keyof typeof presetEmails]?.filter(
  ...
  return (
    <div className='space-y-6'>
      ...
      <Card>
        ...
        <CardContent>
          <div className='flex flex-wrap gap-2'>
            <Button variant='outline' size='sm' onClick={() => addPresetRecipients('principals')}>
              + School Principals
            </Button>
            <Button
              variant='outline'
            ...
            <Button variant='outline' size='sm' onClick={() => addPresetRecipients('teachers')}>
              + Teachers
            </Button>
          </div>
        </CardContent>
      ...
      {formData.recipients.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle className='text-base'>Recipients ({formData.recipients.length})</CardTitle>
          </CardHeader>
          <CardContent>
