      ...
      <div className="space-y-6 sm:space-y-8 pb-8">
        ...
        <div className="flex flex-col gap-6 px-1 sm:px-0">
          ...
          <div className="space-y-1 sm:space-y-2">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-900">Individual Student Reports</h1>
            <p className="text-sm sm:text-base text-gray-600">Generate reports and tools for specific students including progress checks, goal sheets, and assessment reports</p>
          </div>
        </div>
